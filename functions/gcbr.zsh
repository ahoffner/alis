...
printHelp() {
  ...
  descriptionHeader
  description "Shorthand for 'git checkout branch resolution'"
  description "With git, make a new conflict resolution branch from the current branch."
  description "The new branch will be named after the current branch, suffixed with the target branch."
...
printDescription(){
  echo "Make a new conflict resolution branch from the current branch for the target branch <target branch>"
}

alisRun_gcbr() {
  # Output what we're doing
  runSummary "$script_name" "Making a new conflict resolution branch from the current branch for the target branch <target branch>"
